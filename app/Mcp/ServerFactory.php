...
final class ServerFactory
{
    public static function build(?string $sessionPath = null): Server
    {
        ...
        $builder = Server::builder()
            ...
            ->setInstructions('Use list_documentations first. When creating a page, update the menu (.menu.md) if the page should be visible in navigation. Only use Markdown pages and assets/ paths.')
            ...
            ->addTool(fn (string $documentation): string => $tools->getMenu($documentation), 'get_menu', 'Read the navigation menu (.menu.md) for a documentation root.')
            ->addTool(fn (string $documentation, string $content): array => $tools->updateMenu($documentation, $content), 'update_menu', 'Replace the navigation menu (.menu.md) for a documentation root.')
            ...
            ->addTool(fn (string $documentation): array => $tools->validateDocumentation($documentation), 'validate_documentation', 'Validate menu links against existing pages.')
